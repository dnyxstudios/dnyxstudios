...
const socials = [
  { label: "Instagram", href: "https://www.instagram.com/dnyxstudios" },
  { label: "TikTok", href: "https://www.tiktok.com/@dnyxstudios" },
  { label: "YouTube", href: "https://www.youtube.com/@dnyxstudios" },
];
      ...
      <div className="max-w-7xl mx-auto px-10 lg:px-16 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-xs font-semibold uppercase tracking-widest text-[#98989A] mb-3">
              Get in Touch
            </p>
            <Link
              href="/contact"
